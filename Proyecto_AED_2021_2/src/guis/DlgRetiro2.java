...
public class DlgRetiro2 extends JDialog implements ActionListener, KeyListener, MouseListener {
	...
	private JButton btnnumMatricula;
	...
	public void actionPerformed(ActionEvent arg0) {
		if (arg0.getSource() == cbocodAlumno) {
			actionPerformedCbonumMatricula(arg0);
		}
	...
	private String obtenerDatosMatricula() {
	...
	public void mouseClicked(MouseEvent arg0) {
		...
		if (arg0.getSource() == lblImgRetiro) {
	...
	protected void mouseEnteredTblRetiro(MouseEvent arg0) {
		lblImgRetiro.setCursor(new Cursor(Cursor.HAND_CURSOR));
	}
	...
	void listar() {
		...
		if (modelo.getRowCount() > 0)
			posFila = lblImgRetiro.getSelectedRow();
		...
		if (ai.tamaño() > 0)
			lblImgRetiro.getSelectionModel().setSelectionInterval(posFila, posFila);
	}
	void editarFila() {
		if (ai.tamaño() == 0)
			txtnumRetiro.setText("" + ai.codigoCorrelativo());
		else {
			Retiro i = ai.obtener(lblImgRetiro.getSelectedRow());
